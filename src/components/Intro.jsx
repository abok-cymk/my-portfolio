  ...
  return (
    <section className="bg-gray-50  text-black py-16 w-full px-5">
      ...
      <div className="container mx-auto text-center">
        ...
        >
          <p className="mb-3">
            ...
            <span className="font-medium">Computer Science</span>, I am pursuing
            my passion for programming. I enrolled at Maseno University where I
            am learning to be a{" "}
            ...
            <span className="font-medium">industrial attachment</span> in order
            to get industry required skills.
          </p>
      ...
      <div className="flex items-center justify-start gap-2">
        ...
        download
      >
        Download CV <HiDownload className="opacity-60 text-xl" />
      </a>
      <a href="https://linkedin.com" target="_blank" rel="noreferrer">
              <BsLinkedin  className="bg-gray-50 border border-cyan-50 rounded text-2xl text-gray-500"/>
      </a>
